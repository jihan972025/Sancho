...
### Installer
Download [Sancho Setup 1.0.8.exe](https://github.com/jihan972025/Sancho/releases/download/v1.0.8/Sancho.Setup.1.0.8.exe) — all dependencies are bundled (no separate installation required).
